...
\institute{
  Harmony Worldwide / HealChain \and
...
$K[i] = \lfloor 85 \cdot p_i \cdot 2^{64} \rfloor \cdot (27(p_i+1))^{-1}
\bmod p$, where $p_i$ is the $i$-th prime. No LFSR seed trust is required.
